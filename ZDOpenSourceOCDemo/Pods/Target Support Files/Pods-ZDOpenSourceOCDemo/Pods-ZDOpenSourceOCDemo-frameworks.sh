...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DirectoryWatchdog/DirectoryWatchdog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GDPerformanceView/GDPerformanceView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KZPlayground/KZPlayground.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZDNetWorkHelper/ZDNetWorkHelper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ZDTableViewBinding/ZDTableViewBinding.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/dyci/dyci.framework"
